...
define ("WRONG_FILE_TYPE",['code' => 812, 'text' => 'Неверный тип файла']);
define ("TOO_LARGE_FILE",['code' => 813, 'text' => 'Файл слишком велик']);
define ("FILE_SERVER_ERROR",['code' => 814, 'text' => 'Ошибка определения файлового сервера']);
define ("CORRUPTED_FILE",['code' => 815, 'text' => 'Файл был повреждён или удалён']);
